...
/** Real ephemeral keypair used to produce genuine signatures in tests. Expires in 3021. */
...
/** Owner address recovered from `identity`, lowercased as `verify()` returns it. */
export const ownerAddress = identity.authChain[0].payload.toLowerCase()
