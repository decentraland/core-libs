...
import type { ThirdPartyProps, Wearable, WearableRepresentation } from '@dcl/schemas'
import { BodyShape, ContractNetwork, Locale, MappingType, Rarity, WearableCategory } from '@dcl/schemas'
