...
import type { BlockInfo, BlockRepository } from '@dcl/block-indexer'
...
export function createCollectionsSubgraph(items: Array<{ urn: string }>): ISubgraphComponent {
...
export function createDefaultCollectionsL1Subgraph(): ISubgraphComponent {
  return createCollectionsSubgraph(defaultEthereum)
}

export function createDefaultCollectionsL2Subgraph(): ISubgraphComponent {
...
export function createMockBlockRepository(currentBlock: number, blocks: Record<number, number>): BlockRepository {
