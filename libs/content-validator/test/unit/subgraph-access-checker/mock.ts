...
import { createV1andV2collectionAssetValidateFn } from '../../../src/validations/access/subgraph/collection-asset'
...
import type { SubGraphs, SubgraphAccessCheckerComponents, TokenAddresses, ValidateFn } from '../../../src'
import type { ItemCollection } from '../../../src/validations/access/subgraph/collection-asset'
...
export const fetcherWithoutAccess = (): SubGraphs => buildMockedQueryGraph()
...
export function fetcherWithItemsOwnership(
  address: string,
  ens?: Array<{ name: string }>,
  ethereum?: Array<{ urn: string }>,
  matic?: Array<{ urn: string }>,
  blocks?: {
